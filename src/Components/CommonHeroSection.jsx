    ...
    <div className="CommonSection-full-container">
        ...
        <div className='common-hero-section-content-container'>
           ...
           <div className='common-hero-section-content-container'>
            ...
            } className='common-hero-section-button-container'>BACK TO HOME <FaLongArrowAltRight/>
            </button>
        ...
        <div className="CommonSection-second-container">
            <div>
                ...
                <img src={props.image} alt='contact-image' className='image-section-common-section'/>
            </div>
        </div>
