  ...
  return (
    <div className='footer-full-container'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 170">
            <path fill="#fefefe" fillOpacity="1" d="M0,64L48,85.3C96,107,192,149,288,
            ...
            0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z">
                ...
                <div className="footer-links-container">
                    ...
                    <div className="footer-social-media">
                        ...
                        <NavLink to='/https://www.facebook.com'><p><BsFacebook/></p></NavLink>
                        <NavLink to='/mail'><p><MdMail/></p></NavLink>
                        <NavLink to='/twitter'><p> <SiTwitter/> </p></NavLink>
                        <NavLink to='/instagram'><p><AiFillInstagram/></p></NavLink>
                        </div> 
        ...
        <p> @{new Date().getFullYear()}Powered by: Rajesh Bakhrel</p>
        </div>
